...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		if (requestTokenHeader != null && requestTokenHeader.startsWith("JWT ")) {
			...
			if(requestTokenHeader==null)logger.warn("JWT Token does not provided");
			else if (!requestTokenHeader.startsWith("JWT "))logger.warn("JWT Token does not begin with JWT String");
		}
