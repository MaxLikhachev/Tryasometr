...
public class VibrationService {
    ...
    //@Override
    public Vibration add(Vibration vibration){return vibrationRepository.save(vibration);}
    //@Override
    ...
    //@Override
    public List<Vibration> getAll(){return vibrationRepository.findAll();}
    //@Override
    public Vibration edit(Vibration vibration){return vibrationRepository.saveAndFlush(vibration);}
    //@Override
    public void delete(Vibration vibration) {vibrationRepository.delete(vibration);}
    //@Override
    public void remove() {vibrationRepository.deleteAll();}
}
